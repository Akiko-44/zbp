<template>
  <AppView title="修改手机号">
    <MobileValidate v-if="step === 1" service-name="userMobileValidate" @success="checkSuccess" />
      ...
      <template slot-scope="{ error, check }">
        ...
        <div class="input-row">
          <div class="border-input">
            <input v-model="form.mobilePhone" @blur="check('mobilePhone')" autoComplete="on" type="text" placeholder="请设置手机号">
        ...
        <van-button :loading="loading" type="primary" block class="primary-btn block" @click="changeMobile">下一步</van-button>
      </template>
    </Validator>
