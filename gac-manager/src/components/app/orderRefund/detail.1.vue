<template>
  ...
  >
    ...
    <div class="operation">
      <!-- <p>当前退款状态：<span class="red">{{ orderState[form.state] }}</span></p>
      <p>退款金额将原路返回至买家账户中</p>
      ...
      <ul>
        <li>收到买家退货时，请及时验货</li>
        <li>为保障顺利退货，买家申请的退款金额￥3373.00暂做冻结</li>
    ...
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="收货和物流信息">
        ...
        >
          <p v-if="status">物流公司：{{ form.orderExpress.expressCompany }}</p>
          <p v-if="status">物流单号：{{ form.orderExpress.expressNum }}</p>
          <el-table
