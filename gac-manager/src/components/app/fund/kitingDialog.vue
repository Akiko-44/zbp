  ...
  <el-dialog title="提现" :visible.sync="dialogFormVisible">
    <el-form :model="form" :rules="rules" ref="form" label-width="100px">
      <el-form-item label="金额" prop="amount">
        <el-input type="number" v-model.number="form.amount" @change="supplyDwMoney"></el-input>
      </el-form-item>
    </el-form>
    ...
    <form id="test_form" style="display: none !important;" action="https://service.chinaums.com/uisouterfront/withdraw/process" method="post">
			<input name="content" type="text" v-model="content1">
