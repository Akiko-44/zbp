<template>
  <el-dialog title="添加/编辑图片"
    ...
    <el-form :model="form"
      ...
      <el-form-item label="图片(PC)"
                    prop="pcPicture">
        <el-card v-if="form.pcPicture"
                 style="width:250px;"
                 :body-style="{ padding: '0px' }">
          <img :src="form.pcPicture | setImg"
               class="image"
               width="100%">
          <div style="padding: 14px;">
            <div class="bottom clearfix">
              <el-button type="text"
                         class="button"
                         @click="$delete(form, 'pcPicture')">删除</el-button>
            </div>
          </div>
        </el-card>
        <el-button v-else
      ...
      <el-form-item label="图片(移动)"
                    prop="mobilePicture">
        <el-card v-if="form.mobilePicture"
                 style="width:250px;"
                 :body-style="{ padding: '0px' }">
          <img :src="form.mobilePicture | setImg"
               class="image"
               width="100%">
          <div style="padding: 14px;">
            <div class="bottom clearfix">
              <el-button type="text"
                         class="button"
                         @click="$delete(form, 'mobilePicture')">删除</el-button>
            </div>
          </div>
        </el-card>
        <el-button v-else
