<template>
	<div class="app-container calendar-list-container">
	  <div class="clearfix" style="margin-bottom: 20px;">
	    <span>用户名：</span>
	    <el-input v-model="jewelryParams.userName" placeholder="用户名" :maxlength="30" style="width: 150px;"></el-input>
	  ...
	  <el-table :data="tableData" border v-loading="loading">
	    ...
	    <el-table-column
	      ...
	      <template slot-scope="scope">
	      	<el-button
	          size="small"
	          @click="$router.push({ name: 'jewelryCommentDetail', query: { commentId: scope.row.id } })">
	          	查看详情
	          </el-button>
