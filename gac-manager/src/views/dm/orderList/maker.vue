...
<div class="app-container calendar-list-container">
	...
	<el-form :inline="true" :model="listQuery" :rules="rules" ref="listQueryForm" label-width="101px" class="listQueryForm">
...
//    this.getList()
			this.$router.replace({ name: 'makerOrderList', query: { page: val }})
    },
    resetQuery() {
