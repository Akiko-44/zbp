...
<div class="app-container calendar-list-container">
    ...
    <el-button type="primary" v-waves @click="$router.push({ name: 'designAddWork' })">新增商品</el-button>
  </div>
	
  <div class="filter-container">
  	<el-form :inline="true" :model="listQuery" :rules="rules" ref="designWorkListQueryForm" label-width="101px" class="listQueryForm">
  ...
  <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    ...
    <el-table-column width="110px" align="center" label="剩余库存">
      <template slot-scope="{ row }">
        <span>{{row.stock}}</span>
      </template>
    </el-table-column>
    ...
    <el-table-column align="left" label="操作">
      <template slot-scope="{ row, $index }">
        ...
        <el-button
          size="small"
          type="success"
          @click="$router.push({ name: 'designAddWork', query: { id: row.caseId } })"
        >
          修改
        </el-button>
        <el-button
