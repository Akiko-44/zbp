<template>
  <div>
    <!--<el-button :loading="loading" v-if="allowCancelOrder(detail.state)" size="small" type="danger" @click="cancel">取消订单</el-button>-->
	  ...
	  <el-button v-if="allowDeliveryNow(detail.state) && isDelivery" type="primary" plain size="small" @click="dialogFormVisible=true">发货</el-button>-->
...
import {
  allowCancelOrder, allowStartDesign, allowCompleteDesign, allowDelivery, allowCompleteOrder, allowDeliveryNow
...
export default {
  ...
  methods: {
    ...
    isToDelivery(){
    	let list = this.detail.orderGoodVOList
    	let arr = []
