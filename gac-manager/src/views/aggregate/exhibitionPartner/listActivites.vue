	...
	<div>
		...
		<div class="block">
			<el-row>
				...
				<el-button type="primary" style="width:100px;" @click="$router.push({name: 'listActivites_addPartnerList'})">添加活动</el-button>
			</el-row>
			<el-table :data="tableData" style="width: 100%">
				...
				<el-table-column label="操作">
					<template slot-scope="{row}">
						...
						<el-button type="text" size="small" @click="$router.push({name:'listActivites_newAddPartnerList',query: { id: row.id }})">编辑</el-button>
