	...
	<div>
		<div class="block">
			...
			<el-form :inline="true" class="demo-form-inline" label-position="right" label-widt="50%">
				<el-form-item>
					<el-button type="primary" @click="$router.push({name: 'vrtranscript'})">增加VR展示</el-button>
				</el-form-item>
			</el-form>
		</div>
		...
		<div class="box-s">
			<el-table ref="multipleTable" :data="tableData"style="width: 100%">
				...
				<el-table-column label="分类" prop="vrName">
				</el-table-column>
				...
				<el-table-column label="操作" width="200">
					<template slot-scope="scope">
						<el-button type='text' @click="$router.push({name:'vrnewtranscript',query:{id:scope.row.id}})">编辑</el-button>
