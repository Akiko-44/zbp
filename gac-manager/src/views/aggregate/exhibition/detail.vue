<template>
  ...
  <el-form label-width="120px">
    ...
    <el-form-item label="操作">
      <el-button size="small" type="primary" @click="$router.push({ name: 'addExhibition', query: { id: form.id } })">修改</el-button>
    </el-form-item>
...
<script>
import { getObj, getDetailMerPic } from '@/api/aggregate/exhibition'
