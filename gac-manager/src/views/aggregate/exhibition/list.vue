<template>
	<div class="app-container calendar-list-container">
		...
		<div class="filter-container">
			<el-button type="primary" v-waves @click="$router.push({ name: 'addExhibition' })">新建展会</el-button>
		...
		<el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
			...
			<el-table-column fixed="right" align="left" label="操作">
				<template slot-scope="{ row, $index }">
					...
					<el-button size="small" type="primary" @click="$router.push({ name: 'addExhibitionS', query: { id: row.id } })">编辑</el-button>
