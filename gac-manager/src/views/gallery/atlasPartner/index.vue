...
<div class="app-container calendar-list-container">
  <div class="filter-container">
    <el-button @click="$router.push({name: 'atlasPartnerAdd'})" type="primary" icon="edit">添加图集</el-button>
  </div>
  <div class="filter-container">
      ...
      <el-card :body-style="{ padding: '0px' }">
        ...
        <div style="padding: 14px;">
          ...
          <div class="bottom clearfix">
            <el-button type="text" icon="el-icon-edit" @click="$router.push({ name: 'atlasPartnerAdd', query: { id: item.id } })"></el-button>
      ...
      page(this.listQuery)
        .then(data => {
         ...
         //  this.total = data.data.total
          ...
          let newlist = this.listQuery;
          delete newlist.offset;
          delete newlist.limit;
          pageCount(newlist)
        .then(data=>{
