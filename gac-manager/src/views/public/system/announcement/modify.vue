  ...
  >
    ...
    >
      ...
      <!-- <el-form-item
        ...
        prop="notice"
      >
        <el-checkbox-group v-model="noticeForm.notice">
          <el-checkbox
  ...
  created() {
    if (this.id) {
      getNotice({ id: this.id }).then(data => {
        this.noticeForm.id = data.data.id
        this.noticeForm.noticeName = data.data.noticeName
        this.noticeForm.notice = data.data.notice
        this.noticeForm.noticeDetails = data.data.noticeDetails
      })
      this.type = 'update'
    }
  },
