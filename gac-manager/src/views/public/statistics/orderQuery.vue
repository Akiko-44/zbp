      ...
      >
        ...
        >
          <el-input
            ...
            :maxlength="20"
            style="width: 195px;"
            v-model="listParams.orderNumber"
          > </el-input>
        </el-form-item>
        <el-form-item label="订单状态:">
          <el-select
            v-model="listParams.orderState"
            @change="handleFilter"
            clearable
            placeholder="订单状态"
            style="width: 120px;"
      ...
      <div>汇总统计
        ...
        >
          ...
          <div slot="content">
            ...
            <p><strong>企业入网的商家，交易费率以合同上的为准：</strong></p>
            <p>a、PC端扫码支付：费率0.28%</p>
            <p>b、APP-支付宝支付：费率0.60%</p>
            <p>c、APP-微信支付：费率0.63%</p>
            <p>d、H5-支付宝支付：费率0.60%</p>
            <p>e、微信公众号-微信支付：费率0.38%</p>
            <p>个人商家费率统一为0.63%</p>
          </div>
        </el-tooltip>
      </div>
