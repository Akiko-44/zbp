...
<div class="app-container calendar-list-container">
  <div class="filter-container">
    <el-input @keyup.enter.native="handleFilter" style="width: 120px;" v-model="listParams.userId" placeholder="请输入用户ID"> </el-input>
    &nbsp;
    <el-input @keyup.enter.native="handleFilter" style="width: 195px;" v-model="listParams.mobilePhone" placeholder="请输入手机号码"> </el-input>
    &nbsp;
    <el-date-picker
      v-model="dateValue"
  ...
  <div class="statistics-container">
    ...
    <ul>
      ...
      <li>累计已完成金额:<span>￥{{fixedData.cumuTradeAmount}}</span></li>
    ...
    <ul>
      ...
      <li>累计保证金:<span>￥{{(fixedData.cumuSwapDeposit+data.lockAuctionDeposit).toFixed(2)}}</span></li>
      <li>待返还保证金:<span>￥{{(fixedData.lockAuctionDeposit+data.lockSwapDeposit).toFixed(2)}}</span></li>
    </ul>
  </div>
  <div class="statistics-container" v-if="isSummary">
    ...
    <ul>
      ...
      <li>累计已完成金额:<span>￥{{data.cumuTradeAmount}}</span></li>
  ...
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    ...
    <el-table-column align="center" label="开通时间" :sortable="true" sort-by="openTime">
      <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    getFixedList(){
      financeStatistics(2,0).then(data => {
    ...
    getList(){
      ...
      financeStatistics(2,0,this.listParams).then(data => {
        this.data = data.data
    ...
    getExportList(){
      financeStatistics(2,1,{
        userId: this.listParams.userId,
    ...
    handleFilter() {
      if(this.startTime != undefined || this.listParams.userId != undefined || this.listParams.mobilePhone != undefined){
        this.isSummary = true
      }else{
