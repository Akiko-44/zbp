...
<div class="app-container calendar-list-container">
  ...
  <div class="statistics-container" v-if="isSummary">
    ...
    <ul>
      ...
      <li>账户余额:<span>￥{{data.accountBalance}}</span></li>
      <li>待入账金额:<span>￥{{data.lockAmount}}</span></li>
...
export default {
  ...
  methods: {
    getFixedList(){
      financeStatistics(6,0).then(data => {
    ...
    getList(){
      ...
      financeStatistics(6,0,this.listParams).then(data => {
        this.data = data.data
