<template>
  <div class="app-container" style="padding-right: 40px">
    <el-form :model="form" :rules="rules" ref="form" label-width="130px">
      ...
      <el-form-item label="商家图片" prop="merchantPic">
        <el-card
          v-if="form.merchantPic"
          style="width:150px;"
          :body-style="{ padding: '0px' }"
        >
          <img :src="form.merchantPic | setImg" class="image" width="100%" />
          <div style="padding: 0 14px;" v-if="!type">
      ...
      <el-form-item label="推荐描述" prop="recommendDetail">
      ...
      <el-form-item label="商品信息" prop="selectedGoods">
        <el-button
          type="primary"
      ...
      >
        ...
        <el-table-column
          ...
          width="120"
        ></el-table-column>
        <el-table-column fixed="right" align="left" label="操作" v-if="!type">
    ...
    ></enterprise-dialog>
    <goods-dialog ref="goodsDialog" @selectGoods="selectGoods"></goods-dialog>
    <goods-modify-dialog
