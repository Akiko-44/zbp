<template>
  <div class="app-container" style="padding-right: 40px">
    <el-form :model="form" :rules="rules" ref="form" label-width="130px">
      ...
      <el-form-item label="商品信息" prop="moduleRelationList">
        <el-button
          type="primary"
      ...
      >
        ...
        <el-table-column width="100px" align="center" label="价格">
          <template slot-scope="{ row }">
            <span>￥{{ row.lowPrice || row.price }}</span>
          </template>
        </el-table-column>
        <el-table-column
          width="100px"
...
import goodsModifyDialog from './modifyGoods';
...
export default {
  ...
  created() {
    ...
    // this.maxLength = this.goodsType === 0 ? 6 : 4
    this.getHomeModule()
  },
  methods: {
    getHomeModule() {
