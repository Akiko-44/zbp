    ...
    <el-tabs type="border-card">
      <el-tab-pane label="订单信息">
        ...
        <el-table :data="detail.orderGoodVOList" style="width: 100%">
          ...
          <el-table-column width="110px" align="center" label="商品货号">
            <template slot-scope="{ row }">
        ...
        <h4>发票信息</h4>
        <el-form v-if="detail.invoiceType != 0" label-position="left" inline class="table-expand">
        ...
        <h4>操作记录</h4>
        <el-table :data="detail.opList" label-position="left" inline class="table-expand">
          <el-table-column label="操作人">
            <template slot-scope="{ row }">
              <span>{{ row.optionUser }}</span>
            </template>
          </el-table-column>
          <el-table-column label="操作时间">
            <template slot-scope="{ row }">
              <span>{{ row.optionTime }}</span>
            </template>
          </el-table-column>
