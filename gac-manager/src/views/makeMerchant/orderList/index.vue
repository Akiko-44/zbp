...
<div class="app-container calendar-list-container">
	<div class="filter-container">
		<el-form :inline="true" :model="listQuery" :rules="rules" ref="maekeOrderListQueryForm" label-width="101px" class="listQueryForm">
...
//  this.getList()
  ...
  methods: {
    ...
    handleFilter() {
      this.$refs['maekeOrderListQueryForm'].validate((valid) => {
	      if (valid) {
	        this.getList()
	      } else {
	        return false
...
//    this.getList()
    ...
    resetQuery() {
      ...
      this.payDateValue = ''
      this.$refs['maekeOrderListQueryForm'].resetFields()
