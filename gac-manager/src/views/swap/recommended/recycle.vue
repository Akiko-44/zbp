...
<div class="app-container">
  <div class="filter-container">
    <el-button type="primary" icon="edit" @click="handlerAdd" v-if="list.length<6">新增</el-button>
  </div>
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    <el-table-column width="220px" align="left" label="回收信息编号">
    ...
    <el-table-column width="180px" align="center" label="回收标题">
      <template slot-scope="{ row }">
        <span>{{row.goodsName}}</span>
      </template>
    </el-table-column>
    
    <el-table-column width="110px" align="center" label="回收品类">
      <template slot-scope="{ row }">
