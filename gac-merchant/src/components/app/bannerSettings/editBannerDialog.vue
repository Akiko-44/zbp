<template>
  <el-dialog title="添加/编辑图片" :visible.sync="dialogFormVisible">
    <el-form :model="form" :rules="rules" ref="form" label-width="130px">
      <el-form-item label="图片" prop="pcUrl">
        <el-card v-if="form.pcUrl" style="width:250px;" :body-style="{ padding: '0px' }">
          <img :src="form.pcUrl | setImg" class="image" width="100%">
          <div style="padding: 14px;">
            <div class="bottom clearfix">
              <el-button type="text" class="button" @click="form.pcUrl = ''">删除</el-button>
            </div>
          </div>
        </el-card>
