        ...
        >
          ...
          <div slot="content">
            <div style="color: #FF0000;font-size: 12px;margin-bottom: 15px;line-height: 20px;">
              ...
              <div style="padding-left:10px;">a、PC端扫码支付：费率0.28%</div>
              <div style="padding-left:10px;">b、APP-支付宝支付：费率0.60%</div>
              <div style="padding-left:10px;">c、APP-微信支付：费率0.63%</div>
              <div style="padding-left:10px;">d、H5-支付宝支付：费率0.60%</div>
              <div style="padding-left:10px;">e、微信公众号-微信支付：费率0.38%</div>
            </div>
          </div>
        </el-tooltip>
      </el-col>
