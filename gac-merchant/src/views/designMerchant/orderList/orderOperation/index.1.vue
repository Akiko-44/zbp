<template>
  <div class="order-operation">
    ...
    <p>当前订单状态：<span class="red">{{ orderState[detail.state] }}</span></p>
    <p
      style="font-size:12px;"
      v-if="detail.state == 5"
    >*温馨提示：买家还有<span class="red">8天23小时58分12秒</span>来完成本次交易的“确认收货”，如果倒计时结束后，买家没有“确认收货”，也没有“申请仲裁”，那么本次交易将自动确认收货</p>
    <el-button
      :loading="loading"
