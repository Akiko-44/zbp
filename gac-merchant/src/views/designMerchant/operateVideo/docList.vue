  ...
  data() {
    return {
      docList: [
        {
          id: '1',
          docUrl: 'http://app.gacjc.com/app/download/help/designerReleaseGoods.docx',
          title: '发布商品',
          isActive: false
        }, {
          id: '2',
          docUrl: 'http://app.gacjc.com/app/download/help/addDesigner.docx',
          title: '添加设计师',
          isActive: false
        }
      ],
